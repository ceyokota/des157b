...
<strong>The question is: what will you choose to fill your jar with?</strong>`;
    ...
    function setupInteractionFlow() {
        cards.forEach((card, index) => {
            card.addEventListener('click', function() {
                ...
                this.classList.add('selected'); // add the selected class to the card
                
                selectedOptionIndex = index;
                
                confirmBtn.disabled = false; // enables the "confirm" button as soon as the user chooses an answer optoin!
            });
        });
    ...
    function showEndGame() {
        ...
        runInJarColumnSortPipeline(function () {
    ...
    function executeSlowInJarAnnihilationSequence() {
        ...
        if (pairsToDestroy.length > 0) { 
            ...
            const ease = t => t * t * (3 - 2 * t); //ease in and out
